...
impl BenchmarkRunner {
        ...
        Fut: std::future::Future<Output = ()> + Send,
    {
        ...
        for i in 0..self.request_count {
            ...
            if i % 1000 == 0 && self.write_ratio > 0.0 {
                // Simulate error
            }
        }
    ...
    fn compute_stats(latencies: Vec<u64>, errors: u64, total_time: std::time::Duration) -> BenchmarkResult {
        ...
        BenchmarkResult {
            ...
            avg_latency_us: latencies.iter().sum::<u64>() / latencies.len().max(1) as u64,
        }
    }
